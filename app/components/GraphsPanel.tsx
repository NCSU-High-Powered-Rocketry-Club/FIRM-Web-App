    ...
    <section className="mt-4 rounded-xl border border-slate-300 bg-white px-6 pt-3.5 pb-4 shadow-sm text-slate-900">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="flex flex-col rounded-lg border border-slate-300 bg-slate-50/80 p-4">
          <h3 className="mb-2 text-sm font-semibold text-slate-800">IMU (Accel &amp; Gyro)</h3>
        ...
        {/* Magnetometer Graph */}
        <div className="flex flex-col rounded-lg border border-slate-300 bg-slate-50/80 p-4">
          <h3 className="mb-2 text-sm font-semibold text-slate-800">Magnetometer</h3>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
        ...
        {/* Barometer Graph */}
        <div className="flex flex-col rounded-lg border border-slate-300 bg-slate-50/80 p-4">
          <h3 className="mb-2 text-sm font-semibold text-slate-800">Barometer</h3>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <p className="mt-2 text-xs text-slate-500">
        Placeholder data shown. These panels will stream live values from the flight computer.
      </p>
    </section>
  );
}
